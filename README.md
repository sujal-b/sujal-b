# [Sujal Barwad]
**AIML Lead @ GDG | MLOps Engineer | ML Researcher | Data Scientist**

---

#### **Current Focus: DGE-RAG (Dynamic Graph Embeddings)**
I am authoring a research paper on a novel **Spherical Vector Quantizer** that transforms 384-dimensional dense float arrays into discrete **Coarse & Fine Codes**.
* **Innovation:** Reducing memory footprint by orders of magnitude while maintaining retrieval precision.
* **Keywords:** Quantization, Latent Space Optimization, MLOps, RAG.
...
### 📈 Technical Stack
* **Core:** Python (PyTorch, NumPy, Pandas), R, C++
* **Specialization:** MLOps, Vector Quantizer Design, RAG Pipeline Optimization
* **Tools:** Git, Docker, CI/CD for ML, LaTeX

---

### 🌐 Beyond the Code
* **Storytelling:** Documentary photographer focusing on the intersection of human narrative and technical landscapes.
* **Linguistics:** Currently attaining proficiency in **German (A2)**.


[LinkedIn](https://www.linkedin.com/in/sujal-barwad-407444271/) | [Portfolio](http://sujal-barwad.vercel.app)
